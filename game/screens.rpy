...
screen about():
    ...
    use game_menu(_("Acerca de"), scroll="viewport"):
        ...
        vbox:
            ...
            if gui.about:
                text "[gui.about!t]\n"
            text _("Juego realizado por {b}{a=https://www.instagram.com/hildajzmin/}Hilda Araya{/a}{/b} y {b}{a=https://twitter.com/d_prieto}David Prieto{/a}{/b} para la Global Game Jam (el concepto es \"Duality\")\n\n ")
            text _("Hecho con {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
            text _("\n\n")
            text _("También hemos utilizado este material para hacer el teléfono:\n {a=https://badmustard.itch.io/phone-message-system-for-renpy}https://badmustard.itch.io/phone-message-system-for-renpy{/a}")
